...
// Enums
export const publishStatusEnum = pgEnum('publish_status_enum', ['under_review', 'pause', 'rejected', 'published']);
...
export const transactionTypeEnum = pgEnum('transaction_type_enum', ['for_rent', 'for_sale']);
export const propertyStyleEnum = pgEnum('property_style_enum', ['modern', 'traditional']);
export const propertyUsageEnum = pgEnum('property_usage_enum', ['residential', 'commercial']);
export const finishingQualityEnum = pgEnum('finishing_quality_enum', ['economic', 'medium', 'high']);
export const sunLightLevelEnum = pgEnum('sun_light_level_enum', ['weak', 'medium', 'high']);
...
export const propertiesRelations = relations(properties, ({ one }) => ({
  ...
  googleAddress: one(googleAddresses, { fields: [properties.googleAddressId], references: [googleAddresses.id] }),
}));
